...
# <UDF name="goatcounter_version"  label="GoatCounter version"                     default="v2.1.0" />
#
...
#    GOATCOUNTER_VERSION     GoatCounter version (default: v2.1.0).
#
