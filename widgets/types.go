...
func (w Totals) Type() string     { return "" }
func (w AllTotals) Type() string  { return "" }
func (w Pages) Type() string      { return "full-width" }
func (w Max) Type() string        { return "" }
func (w Totalpages) Type() string { return "full-width" }
func (w Refs) Type() string       { return "" }
...
func (w *Totals) SetHTML(h template.HTML)     { w.html = h }
func (w *AllTotals) SetHTML(h template.HTML)  { w.html = h }
func (w *Pages) SetHTML(h template.HTML)      { w.html = h }
func (w *Max) SetHTML(h template.HTML)        { w.html = h }
func (w *Totalpages) SetHTML(h template.HTML) { w.html = h }
func (w *Refs) SetHTML(h template.HTML)       { w.html = h }
